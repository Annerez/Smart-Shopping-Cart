...
export const SystemBar = ({
  ...
  capacityClassName,
  cap = "https://cdn.animaapp.com/projects/61ef7aa2dd0b21a3ff5d423c/releases/6532585bb35383690516e023/img/cap.svg",
  ...
  return (
    <div className={`system-bar ${device} ${className}`}>
      ...
      {device === "iphone-x" && (
        <Starus
          className={`${theme === "dark" ? "class" : "class-2"}`}
          theme={theme === "dark" ? "dark" : "light"}
          timeClassName={`${theme === "dark" ? "class-3" : "class-4"}`}
          type="time"
        />
      )}
    </div>
